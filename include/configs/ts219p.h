...
#ifndef _CONFIG_TS219P_H
#define _CONFIG_TS219P_H
...
#define CONFIG_MACH_TS219P		/* Machine type */
#define CONFIG_MACH_TYPE	MACH_TYPE_TS219P
...
#define CONFIG_SYS_PROMPT	"TS219P> "	/* Command Prompt */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mtdparts=mtdparts=orion_nand:0x80000(uboot),0x200000(kernel),-(rootfs)\0" \
	"rootdelay=10\0" \
	"rootfstype=ext2\0" \
